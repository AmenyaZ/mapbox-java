...
public abstract class DirectionsRouteRefresh extends DirectionsRefreshJsonObject {
  ...
  /**
   * A Leg Refresh is an object contain refresh data between only two two {@link DirectionsWaypoint}.
   *
  ...
  /**
   * Convert the current {@link DirectionsRouteRefresh} to its builder holding the currently assigned
   * values. This allows you to modify a single property and then rebuild the object resulting in
   * an updated and modified {@link DirectionsRouteRefresh}.
   *
   * @return a {@link DirectionsRouteRefresh.Builder} with the same values set to match the ones defined
   *   in this {@link DirectionsRouteRefresh}
   */
